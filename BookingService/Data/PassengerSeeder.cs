    ...
    public static void SeedPassengers(this ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Passenger>().HasData(
            ...
            new Passenger
            {
                ...
                FirstName = "Mary",
                LastName = "Smith",
                DateOfBirth = new DateOnly(1987, 3, 22),
            ...
            new Passenger
            {
                ...
                FirstName = "Lin",
                LastName = "Chen",
                DateOfBirth = new DateOnly(1982, 7, 3),
            ...
            new Passenger
            {
                ...
                FirstName = "Jason",
                LastName = "Chen",
                DateOfBirth = new DateOnly(2010, 2, 25),
            ...
            new Passenger
            {
                ...
                FirstName = "David",
                LastName = "Wilson",
                DateOfBirth = new DateOnly(1975, 5, 27),
            ...
            new Passenger
            {
                ...
                FirstName = "Elizabeth",
                LastName = "Wilson",
                DateOfBirth = new DateOnly(1978, 12, 4),
